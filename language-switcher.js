        ...
        navContainer.insertAdjacentHTML(
            ...
            <div class="lang-switcher">
                ...
                <div class="lang-menu" id="lang-menu" role="menu">
                    ...
                    <button type="button" class="lang-option" data-lang="ja" role="menuitem">日本�?/button>
        ...
        'index.html': {
            textNodes: {
                ...
                'home-subtitle': {
                    ...
                    'zh-CN': '欢迎来到我们�?Hobby Horsing Club！感受优雅、速度与自然的完美结合�?,
                ...
                'footer-copy': {
                    en: '© 2026 Hobby Horsing Club. . All rights reserved.',
        ...
        'history.html': {
            textNodes: {
                ...
                'heritage-copy': {
                    ...
                    'zh-CN': '每一�?Hobby Horse 都承载着制作者的工艺与骑手的独特个性。我们相信，物质与热爱结合，能够让人重新回到自然�?,
                    'zh-TW': '每一�?Hobby Horse 都承載著製作者的工藝與騎手的獨特個性。我們相信，物質與熱愛結合，能讓人重新回到自然�?,
        ...
        'news.html': {
            textNodes: {
                ...
                'announcement-copy': {
                    ...
                    'zh-CN': '秋季冠军赛将设专业组与公开组。带上你�?Hobby Horse 参加比赛，争夺金色奖杯！',
                    'zh-TW': '秋季冠軍賽將設專業組與公開組。帶上你�?Hobby Horse 參加比賽，爭奪金色獎盃！',
                ...
                'camp-title': {
                    ...
                    'zh-CN': '初学者手工与骑乘工作坊圆满成�?,
                    'zh-TW': '初學者手工與騎乘工作坊圓滿成�?,
...
'golden_horse.html': {
            textNodes: {
                ...
                'social-copy': {
                    ...
                    'zh-CN': '投票只是开始。把你最喜欢的片段分享至 TikTok �?Instagram，并标记 #hobbyhorsingfunnies，即可参�?Golden Badge 抽奖�?,
                    'zh-TW': '投票只是開始。把你最喜歡的片段分享至 TikTok �?Instagram，並標記 #hobbyhorsingfunnies，即可參�?Golden Badge 抽獎�?,
                    ...
                    ja: '投票はまだ半分です。お気に入りのクリップを TikTok また�?Instagram �?#hobbyhorsingfunnies と一緒に共有して、Golden Badge のプレゼントに応募しましょう�?,
        ...
        'membership.html': {
            textNodes: {
                ...
                'rider-motto-placeholder': {
                    ...
                    'zh-CN': '分享你对 Hobby Horsing 的热�?..',
                    'zh-TW': '分享你對 Hobby Horsing 的熱�?..',
